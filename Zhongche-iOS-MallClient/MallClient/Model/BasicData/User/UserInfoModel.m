...
- (void)encodeWithCoder:(NSCoder *)aCoder{
    ...
    [aCoder encodeObject:_accountAmount forKey:@"accountAmount"];
    [aCoder encodeObject:_creditLimit forKey:@"creditLimit"];
    [aCoder encodeObject:_notReadMessageCount forKey:@"notReadMessageCount"];
    [aCoder encodeObject:_companyStatus forKey:@"companyStatus"];
    [aCoder encodeObject:_propertyType forKey:@"propertyType"];
    [aCoder encodeObject:_companyType forKey:@"companyType"];
    [aCoder encodeObject:_quaAuthStatus forKey:@"quaAuthStatus"];
    [aCoder encodeObject:_companyPhone forKey:@"companyPhone"];
...
- (id)initWithCoder:(NSCoder *)aDecoder{
    if (self=[super init]) {
        ...
        _userType = [[aDecoder decodeObjectForKey:@"userType"] copy];
        _accountAmount = [[aDecoder decodeObjectForKey:@"accountAmount"] copy];
        _creditLimit = [[aDecoder decodeObjectForKey:@"creditLimit"] copy];
        _notReadMessageCount = [[aDecoder decodeObjectForKey:@"notReadMessageCount"] copy];
        _companyStatus = [[aDecoder decodeObjectForKey:@"companyStatus"] copy];
        _propertyType = [[aDecoder decodeObjectForKey:@"propertyType"] copy];
        _companyType = [[aDecoder decodeObjectForKey:@"companyType"] copy];
        _quaAuthStatus = [[aDecoder decodeObjectForKey:@"quaAuthStatus"] copy];
        _companyPhone  =[[aDecoder decodeObjectForKey:@"companyPhone"] copy];
