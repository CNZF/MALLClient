...
- (void)binView {
    ...
    self.lbDeposit.frame =  CGRectMake(self.ivTransport.right + 10, self.lbPrice.bottom + 10, 120, 20);
    [self.viShow addSubview:self.lbDeposit];

    self.lbNum.frame =  CGRectMake(self.lbDeposit.right , self.lbPrice.bottom + 10, 100, 20);
...
- (UILabel *)lbDeposit {
    ...
    if (!_lbDeposit) {
        ...
        label.text = @"押金：¥7000";
        label.frame = CGRectMake(0, self.lbPrice.bottom + 15, SCREEN_W/3 + 20, 15);
