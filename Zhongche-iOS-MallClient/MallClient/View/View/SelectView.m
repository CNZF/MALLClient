...
+(SelectView *)addSelectViewWithEntrys:(NSArray *)entrys WithSelectEntry:(NSString *)entry WithCallback:(void (^)(NSString *))callback
{
    ...
    for (int i = 0;  i < entrys.count; i ++)
    {
        ...
        line = [[UIView alloc]initWithFrame:CGRectMake(0, button.height - 1, SCREEN_W, 0.5)];
...
//    [self addSubview:effe];
    ...
    bgvi.frame = CGRectMake(0, 0, SCREEN_W, SCREEN_H);
    bgvi.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.7];
