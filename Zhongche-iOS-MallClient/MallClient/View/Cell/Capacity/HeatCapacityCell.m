...
-(void)loadUIWithmodel:(id)model
{
    if ([model isKindOfClass:[NSArray class]]) {
        ...
        if (models.count >= 1)
        {
            ...
            NSMutableAttributedString * priceLab1Text = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"¥%@",[model1.price NumberStringToMoneyString]]];
            [priceLab1Text addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:15.0f] range:NSMakeRange(0,priceLab1Text.length)];
            [priceLab1Text addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:10.0f] range:[priceLab1Text.string rangeOfString:[model1.price NumberStringToMoneyStringGetLastThree]]];
            self.priceLab1.attributedText = priceLab1Text;
            ...
            if (models.count == 2) {
                ...
                NSMutableAttributedString * priceLab2Text = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"¥%@",[model2.price NumberStringToMoneyString]]];
                [priceLab2Text addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:15.0f] range:NSMakeRange(0,priceLab2Text.length)];
                [priceLab2Text addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:10.0f] range:[priceLab2Text.string rangeOfString:[model2.price NumberStringToMoneyStringGetLastThree]]];
                self.priceLab2.attributedText = priceLab1Text;
