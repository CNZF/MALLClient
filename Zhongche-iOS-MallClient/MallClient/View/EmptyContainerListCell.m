...
{
    [self.imageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/%@",BASEIMGURL,model.imgurl]] placeholderImage:[UIImage imageNamed:@""]];
    ...
    NSMutableAttributedString * attrString = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"¥%@/%@",model.unitPrice,model.unit]];
    //设置字体
...
-(void)bindView
{
    ...
    self.line_01.frame = CGRectMake(0, 210, SCREEN_W / 2, 1);
    [self addSubview:self.line_01];
    
    self.line_02.frame = CGRectMake(SCREEN_W / 2 - 1, 0, 1, 211);
