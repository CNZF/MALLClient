...
-(void)bindView
{
    self.searchBar.frame = CGRectMake(0, 64 * (self.fromNaviC?0:1), SCREEN_W, 44);
    [self.view addSubview:self.searchBar];
    
    self.cityList.frame = CGRectMake(0, CGRectGetMaxY(self.searchBar.frame), SCREEN_W, SCREEN_H -  CGRectGetMaxY(self.searchBar.frame) - 64 * (self.fromNaviC?1:0));
