...
- (void)bindView {
    ...
    self.ivSuccess.frame = CGRectMake(SCREEN_W/2 - 67, 20, 134, 134);
    ...
    self.lbBottom1.frame = CGRectMake(0, self.btnGotoOrder.bottom + 64, SCREEN_W, 20);
    [self.view addSubview:self.lbBottom1];

    self.lbBottom2.frame = CGRectMake(0, self.lbBottom1.bottom + 10, SCREEN_W, 20);
