...
//    self.view.backgroundColor = APP_COLOR_WHITE_BTN;
    self.tvVIAInvoiceList.backgroundColor = APP_COLOR_WHITE_BTN;
    self.tvCommenInvoiceList.backgroundColor = APP_COLOR_WHITE_BTN;
    self.AddNewBtn.layer.cornerRadius = 4.0f;
    self.AddNewBtn.layer.masksToBounds = YES;
    self.AddNewBtn.frame = CGRectMake(15, SCREEN_H- kiPhoneFooterHeight - kNavBarHeaderHeight - 65, SCREEN_W- 30, 50);
    
    self.ViVATinvoice.frame = CGRectMake(0, 50, SCREEN_W, SCREEN_H - 50 - kNavBarHeaderHeight - kiPhoneFooterHeight - 80);
    self.ViVATinvoice.backgroundColor = APP_COLOR_WHITE_BTN;
    [self.view addSubview:self.ViVATinvoice];

    self.ViVATinvoice.hidden = YES;

    self.viCommonInvoice.frame = CGRectMake(0, 50, SCREEN_W, SCREEN_H - 50 - kNavBarHeaderHeight - kiPhoneFooterHeight - 80);
    self.viCommonInvoice.backgroundColor = APP_COLOR_WHITE_BTN;
...
- (void)setDefaultAction:(UIButton *)btn {
    ...
    [vm setDefaultInVoiceWithId:model.ID type:model.type callback:^(NSString *orderNo) {
...
- (IBAction)chooseAction:(id)sender {
    ...
    if (![self.ViVATinvoice isHidden]) {
        ...
        self.ViVATinvoice.hidden = YES;
        [self.btnChoose setImage:[UIImage imageNamed:@"zzszy"] forState:UIControlStateNormal];
        ...
        [self.btnChoose setImage:[UIImage imageNamed:@"zzspt"] forState:UIControlStateNormal];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (tableView.tag == 11) {
        ...
        if (model.isShowAll ==1) {
             return self.isEdite == 0?238 - 45 + 145 - 8:383 - 8;
        }
...
//            }
            ...
            [cell.btnShowAll setTitle:@"" forState:UIControlStateNormal];
            ...
            if (indexPath.row == 0) {
                ...
                cell.rightConers.constant = 46.0f;
            }else{
                cell.rightConers.constant = 15.0f;
            }
...
//            }
    ...
    if (indexPath.row == 0) {
        cell.ivDefault.hidden = NO;
        cell.rightCorners.constant = 46.0f;
    }else{
        cell.rightCorners.constant = 15.0f;
    }
