...
- (void)bindView {
    ...
    ninaPagerView.frame = CGRectMake(0, 0, SCREEN_W, SCREEN_H - 108);
...
- (NSArray *)ninaVCsArray {
    return @[
             @"OrderCenterListVC_IWantToCapacity",
             @"OrderCenterListVC_HomeOfEmpty",
             @"OrderCenterListVC_EmptyLove",
             @"OrderCenterListVC_Coal"
             ];
}
