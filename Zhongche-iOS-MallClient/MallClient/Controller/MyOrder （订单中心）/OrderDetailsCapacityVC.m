...
@interface OrderDetailsCapacityVC ()<UIAlertViewDelegate>
...
@implementation OrderDetailsCapacityVC
...
-(void)bindModel {
    ...
    [[OrderViewModel new] getSaleOfCapacityOrderDetailsWithOrderId:self.model.ID callback:^(OrderModelForCapacity *model) {
        if (![model.ordetType isEqualToString:ws.model.ordetType]) {
...
-(void)updateUIWithModel:(OrderModelForCapacity *)model {
    ...
    self.goodsTypeLab.text = [NSString stringWithFormat:@"运力类型: %@",model.capacityType];
    if(model.goodsName){
        ...
        self.goodsNameLab.text = [NSString stringWithFormat:@"车辆名称: %@",model.vehicleType];
    }
    ...
    if (!model.doorToDoorPrice) {
        model.doorToDoorPrice = @"";
    }
    NSMutableAttributedString * doorToDoorPriceLabText = [[NSMutableAttributedString alloc] initWithString: [NSString stringWithFormat:@"¥%@ x%@",[model.doorToDoorPrice NumberStringToMoneyString],model.boxNum]];
    [doorToDoorPriceLabText addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:14.0f] range:NSMakeRange(0,doorToDoorPriceLabText.length)];
    [doorToDoorPriceLabText addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:10.0f] range:[doorToDoorPriceLabText.string rangeOfString:[model.doorToDoorPrice NumberStringToMoneyStringGetLastThree]]];
    self.doorToDoorPriceLab.attributedText = doorToDoorPriceLabText;
//    self.pointToPointPriceLab.text = [NSString stringWithFormat:@"¥%@",model.pointToPointPrice];
    if (!model.pickupPrice) {
        model.pickupPrice = @"";
    }
    NSMutableAttributedString * pointToPointPriceLabText = [[NSMutableAttributedString alloc] initWithString: [NSString stringWithFormat:@"¥%@",[model.pickupPrice NumberStringToMoneyString]]];
    [pointToPointPriceLabText addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:14.0f] range:NSMakeRange(0,pointToPointPriceLabText.length)];
    [pointToPointPriceLabText addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:10.0f] range:[pointToPointPriceLabText.string rangeOfString:[model.pickupPrice NumberStringToMoneyStringGetLastThree]]];
    self.pointToPointPriceLab.attributedText = pointToPointPriceLabText;
    if (!model.deliveryPrice) {
        model.deliveryPrice = @"";
    }
    NSMutableAttributedString * insurancePriceLabText = [[NSMutableAttributedString alloc] initWithString: [NSString stringWithFormat:@"¥%@",[model.deliveryPrice NumberStringToMoneyString]]];
    [insurancePriceLabText addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:14.0f] range:NSMakeRange(0,insurancePriceLabText.length)];
    [insurancePriceLabText addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:10.0f] range:[insurancePriceLabText.string rangeOfString:[model.deliveryPrice NumberStringToMoneyStringGetLastThree]]];
    self.insurancePriceLab.attributedText = insurancePriceLabText;
    ...
    if ([model.ordetType isEqualToString:@"待付款"]) {
        ...
        NSMutableAttributedString * needPaymentLabText = [[NSMutableAttributedString alloc] initWithString: [NSString stringWithFormat:@"¥%@",[model.waitPrice NumberStringToMoneyString]]];
        [needPaymentLabText addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:14.0f] range:NSMakeRange(0,needPaymentLabText.length)];
        [needPaymentLabText addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:10.0f] range:[needPaymentLabText.string rangeOfString:[model.waitPrice NumberStringToMoneyStringGetLastThree]]];
        self.needPaymentLab.attributedText = needPaymentLabText;
        ...
        NSMutableAttributedString * paymentHasBeenLabText = [[NSMutableAttributedString alloc] initWithString: [NSString stringWithFormat:@"¥%@",[model.paidPrice NumberStringToMoneyString]]];
        [paymentHasBeenLabText addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:14.0f] range:NSMakeRange(0,paymentHasBeenLabText.length)];
        [paymentHasBeenLabText addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:10.0f] range:[paymentHasBeenLabText.string rangeOfString:[model.paidPrice NumberStringToMoneyStringGetLastThree]]];
        self.paymentHasBeenLab.attributedText = paymentHasBeenLabText;
        ...
        [paymentHasBeenLabText addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:10.0f] range:[paymentHasBeenLabText.string rangeOfString:[model.paidPrice NumberStringToMoneyStringGetLastThree]]];
        self.paymentHasBeenLab.attributedText = paymentHasBeenLabText;
        if (!model.unconfirmedPrice ) {
            model.unconfirmedPrice = @"";
        }
        NSMutableAttributedString * needConfirmLabText = [[NSMutableAttributedString alloc] initWithString: [NSString stringWithFormat:@"¥%@",[model.unconfirmedPrice NumberStringToMoneyString]]];
        [needConfirmLabText addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:14.0f] range:NSMakeRange(0,needConfirmLabText.length)];
        [needConfirmLabText addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:10.0f] range:[needConfirmLabText.string rangeOfString:[model.unconfirmedPrice NumberStringToMoneyStringGetLastThree]]];
        self.needConfirmLab.attributedText = needConfirmLabText;
...
- (UIView *)branchesView {
    if (!_branchesView) {
        ...
        line.frame = CGRectMake(0, 44, SCREEN_W, 0.5);
...
- (UIView *)orderView {
    if (!_orderView) {
        ...
        line_01.frame = CGRectMake(0, 110, SCREEN_W, 0.5);
        ...
        line_02.frame = CGRectMake(15, 182, SCREEN_W, 0.5);
        ...
        line_03.frame = CGRectMake(15, 228, SCREEN_W, 0.5);
        ...
        line_04.frame = CGRectMake(15, 325, SCREEN_W, 0.5);
