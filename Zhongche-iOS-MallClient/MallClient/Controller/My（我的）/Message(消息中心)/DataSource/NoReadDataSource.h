...
#import <Foundation/Foundation.h>
 ...
 typedef void(^NoReadDataBlock)(NSArray * NoReadDataArray);
typedef void(^AllCurttenPageDataBlock)(NSArray * curttenArray);
@interface NoReadDataSource : NSObject<UITableViewDataSource>
...
@property (nonatomic, copy) NoReadDataBlock noReadDataBlock;
